// src/components/cards/CardNutricionTriatletas.js
import React from 'react';

const CardNutricionTriatletas = ({ isActive, onToggle }) => {
  const plan = {
    title: "Nutrición para Triatletas",
    description: "Recetas equilibradas para triatletas que practican correr, nadar y andar en bicicleta.",
    items: [
      "Comidas fáciles de digerir antes de la competencia",
...
export default CardNutricionTriatletas;

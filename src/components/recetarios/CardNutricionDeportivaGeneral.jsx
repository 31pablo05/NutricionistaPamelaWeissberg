// src/components/cards/CardNutricionDeportivaGeneral.js
import React from 'react';

const CardNutricionDeportivaGeneral = ({ isActive, onToggle }) => {
  const plan = {
    title: "Nutrición Deportiva General",
    description: "Recetarios para aumentar energía y rendimiento en cualquier actividad física.",
    items: [
      "Batidos energéticos",
...
export default CardNutricionDeportivaGeneral;
